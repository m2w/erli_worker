...
init_per_suite(Config) ->
    ...
    RootUrl = "http://localhost:" ++ PortS ++ "/targets/",
...
post_json_data(Config) ->
    ...
    erli_storage:write(ConflictingTarget),
...
idempotent_calls_to_entity(Config) ->
    ...
    Obj = erli_storage:write(#target{url=Url}),
    BannedTarget = #target{url=BannedUrl, is_banned=true,
			   flag_count=9000},
    BannedObj = erli_storage:write(BannedTarget),
